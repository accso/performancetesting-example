 ...
 */
package de.accso.performancetesting.domain;
...
public class Customer implements Serializable {
    ...
    public Customer(String nachname, String vorname, List<Product> favorites) {
        super();
    ...
    public void addFavorite(Product favorite) {
